...
export const it: WizardTranslationMap = {
  common: {
    back: "Indietro",
    done: "Fatto",
    docs: "Documentazione:",
    ...
    tokenRecommended: "Token (consigliato)",
  },
  wizard: {
    customProvider: {
      apiBaseUrl: "URL base API",
      apiKeyPrompt: "Chiave API (lascia vuoto se non serve)",
      changeBaseUrl: "Cambia URL base",
      changeBaseUrlAndModel: "Change base URL and model",
      changeModel: "Cambia modello",
      compatibility: "Compatibilità endpoint",
      compatibilityAnthropic: "Compatibile Anthropic",
      compatibilityAnthropicHint: "Uses /messages",
      compatibilityOpenAi: "Compatibile OpenAI",
      compatibilityOpenAiHint: "Uses /chat/completions",
      compatibilityUnknown: "Sconosciuto (rileva automaticamente)",
      compatibilityUnknownHint: "Probes OpenAI then Anthropic endpoints",
      detectionFailed: "Impossibile rilevare il tipo di endpoint.",
      detectionFailedNote: "Questo endpoint non ha risposto a richieste in stile OpenAI o Anthropic.",
      detectionNoteTitle: "Rilevamento endpoint",
      detectionProgress: "Rilevamento del tipo di endpoint in corso...",
      detectedAnthropic: "Rilevato endpoint compatibile Anthropic.",
      detectedOpenAi: "Rilevato endpoint compatibile OpenAI.",
      endpointId: "ID Endpoint",
      endpointIdRequired: "L'ID Endpoint è obbligatorio.",
      endpointIdRenamed:
        'Endpoint ID "{from}" already exists for a different base URL. Using "{to}".',
      endpointIdTitle: "Endpoint ID",
      imageInput: "Questo modello supporta input di immagini?",
      modelAlias: "Alias del modello (opzionale)",
      modelAliasPlaceholder: "es. local, ollama",
      modelId: "ID del modello",
      modelIdPlaceholder: "es. llama3, claude-3-7-sonnet",
      modelIdRequired: "L'ID del modello è obbligatorio",
      retryChoice: "Cosa vuoi cambiare?",
      verifying: "Verifica in corso...",
      verificationFailedError: "Verifica fallita: {error}",
      verificationFailedStatus: "Verification failed: status {status}",
      verificationSuccessful: "Verifica completata con successo.",
      validUrl: "Inserisci un URL valido (es. http://...)",
    },
    gateway: {
      accessProtection: "Protezione accesso al Gateway",
      auth: "Autenticazione Gateway",
      ...
      bindAddress: "Indirizzo bind del Gateway",
      bindAuto: "Automatico (Loopback -> LAN)",
      bindAutoHint: "Prova prima il loopback",
      bindCustom: "IP personalizzato",
      bindCustomHint: "Collega a un singolo indirizzo locale",
      bindCustomIp: "Indirizzo IP personalizzato",
      bindLan: "LAN (0.0.0.0)",
      bindLanHint: "Raggiungibile sulla tua rete locale",
      bindLoopback: "Loopback (127.0.0.1)",
      bindLoopbackHint: "Solo questa macchina",
      ...
      passwordPrompt: "Password del Gateway",
      plaintextPasswordHint: "Salva la password direttamente nella configurazione di KUIO",
      plaintextPasswordLabel: "Inserisci la password ora",
      plaintextTokenHint: "Predefinito",
      plaintextTokenLabel: "Genera/salva token in chiaro",
      port: "Porta del Gateway",
      refHint: "Salva un riferimento invece del valore in chiaro",
      refLabel: "Usa SecretRef",
      ...
      tokenPrompt: "Token del Gateway",
      tokenPromptGenerate: "Token Gateway (vuoto per generarlo automaticamente)",
      websocketUrl: "URL WebSocket del Gateway",
    },
    gatewayTailscale: {
    ...
    remote: {
      ...
      plaintextPasswordHint: "Salva la password direttamente nella configurazione di KUIO",
      plaintextPasswordLabel: "Inserisci la password ora",
      plaintextTokenHint: "Stores the token directly in KUIO config",
    ...
    setup: {
      ...
      intro: "Configurazione di KUIO",
      invalidConfigTitle: "Configurazione non valida",
      keepCurrent: "Mantieni valori attuali",
      localGateway: "Gateway locale (questa macchina)",
      localGatewayMissing: "Nessun Gateway rilevato ({url})",
      localGatewayReachable: "Gateway raggiungibile ({url})",
      modifyCurrent: "Rivedi e aggiorna",
      pluginCompatibilityTitle: "Compatibilità plugin",
      quickstartOnlyLocal: "L'avvio rapido supporta solo Gateway locali. Passaggio alla modalità Manuale.",
      quickstartTitle: "Avvio rapido",
      quickstartAuthTokenDefault: "Token (predefinito)",
      quickstartDirectChannels: "Connessione diretta ai canali di chat.",
      quickstartGatewayAuth: "Autenticazione Gateway: {auth}",
      quickstartGatewayBind: "Bind Gateway: {bind}",
      quickstartGatewayCustomIp: "Gateway custom IP: {host}",
      quickstartGatewayPort: "Porta Gateway: {port}",
      quickstartKeepSettings: "Mantengo le impostazioni attuali del Gateway:",
      quickstartTailscaleExposure: "Tailscale exposure: {exposure}",
      remoteConfigured: "Gateway remoto configurato.",
      remoteGateway: "Gateway remoto (solo info)",
      remoteGatewayMissing: "Nessun URL remoto configurato",
      remoteGatewayReachable: "Gateway raggiungibile ({url})",
      remoteGatewayUnreachable: "Configurato ma non raggiungibile ({url})",
      resetBefore: "Reset prima della configurazione",
      resetConfig: "Solo configurazione",
      resetConfigCredsSessions: "Configurazione + credenziali + sessioni",
      resetFull: "Reset completo (configurazione + credenziali + sessioni + workspace)",
      resetScope: "Ambito del reset",
    ...
    security: {
      ...
      beta: "KUIO è in fase beta — potrebbero esserci ancora piccoli imprevisti.",
      confirm:
        "I understand this is personal-by-default and shared/multi-user use requires lock-down. Continue?",
      hardeningRequired:
        "Se non hai dimestichezza con le impostazioni di sicurezza, contattaci prima di proseguire.",
      learnMore: "Learn more",
      notMultitenant: "KUIO è pensato per un singolo utente, non come servizio multi-utente protetto.",
      personalAgent: "KUIO è il tuo segretario personale: una sola persona di fiducia ai comandi.",
    ...
    nextcloudTalk: {
      ...
      helpInstallCommand:
        '2) Run: ./occ talk:bot:install "KUIO" "<shared-secret>" "<webhook-url>" --feature webhook --feature response --feature reaction',
    ...
    whatsapp: {
      ...
      ownerNumberNote: "We need the sender/owner number so KUIO can allowlist you.",
      ...
      separatePhoneLabel: "Separate phone just for KUIO",
    ...
    synologyChat: {
      ...
      incomingWebhookHelpReplies: "This is the URL KUIO uses to send replies back to Chat.",
    ...
    signal: {
      ...
      multipleEntries: "Multiple entries: comma-separated.",
      nextLinkDevice: 'Link device with: signal-cli link -n "KUIO"',
    ...
    channelsPrimer: {
      ...
      blurbs: {
        ...
        synologyChat: "Connect your Synology NAS Chat to KUIO with full agent capabilities.",
    ...
    finalize: {
      ...
      dashboardCopyPaste: "Copy/paste this URL in a browser on this machine to control KUIO.",
      dashboardLinkWithToken: "Dashboard link (with token): {url}",
      dashboardOpened: "Opened in your browser. Keep that tab to control KUIO.",
      ...
      outroDashboardLink: "Onboarding complete. Use the dashboard link above to control KUIO.",
      outroDashboardOpened:
        "Onboarding complete. Dashboard opened; keep that tab to control KUIO.",
      outroSeeded:
